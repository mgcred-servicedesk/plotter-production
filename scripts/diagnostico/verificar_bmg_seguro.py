...
def verificar_bmg_seguro_em_analise(mes: int, ano: int):
    ...
    if resp.data:
        ...
        if not df_bmg_med.empty:
            ...
            print("      (deveria estar em 'contratos pagos' quando liquidado)")
    ...
    if resp_pagos.data:
        ...
        if not df_bmg_med.empty:
            ...
            if valor_total > 0:
                ...
                print("      Deveria ter conta_valor=false e valor zerado no dashboard")
        else:
    ...
    if resp_cat.data:
        ...
        for _, row in df_cat.iterrows():
            ...
            if row['conta_valor']:
                print("   ✅ Valor será contabilizado")
            else:
                print("   ✅ Valor será ZERADO no dashboard (apenas quantidade)")
